...
class EditOrganizationNameForm extends StatefulWidget {
  final bool isLoading;
  final String initialName;
  final void Function(String name) onSubmit;

  const EditOrganizationNameForm({
    super.key,
  ...
  @override
  State<EditOrganizationNameForm> createState() => _EditOrganizationNameFormState();
}

class _EditOrganizationNameFormState extends State<EditOrganizationNameForm> {
  ...
  Widget build(BuildContext context) {
    return Form(
      ...
      child: Column(
        ...
        children: [
          Text(
            AppLocalizations.of(context)!.org_form_edit_title,
